            ...
            <div id="validTicket-formDiv">
                ...
                <form id="validTicket-form" method="POST">
                    ...
                    <div class="validBillet-div">
                        <input type="text" id="validTicket-code" name="validTicket-code" placeholder="Code billet"
                               required>
                    ...
                    <div class="dateScan-div">
                        <div class="validBillet-div">
                            <input type="date" id="validTicket-date" name="validTicket-date" placeholder="Date"
                                   required>
                    ...
                    <div class="validBillet-div">
                        <input type="password" id="validTicket-password" name="validTicket-password"
