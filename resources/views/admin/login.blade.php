...
@section('content')
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="bg-white-100 p-8 rounded-lg shadow-md w-full max-w-md" style="border-radius: 39px;">
            ...
            <form action="{{ route('admin.login') }}" method="POST">
                ...
                <div class="flex justify-center">
                    <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700">Connexion</button>
                </div>
            </form>
        </div>
    </div>
