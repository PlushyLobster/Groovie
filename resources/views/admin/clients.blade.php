        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <table id="clients-table" class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Compte
                    </th>
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nb
                        Groovies
                    </th>
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Niveau
                    </th>
                    <th scope="col"
                    ...
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">M.a.j
                    </th>
                    <th scope="col"
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <button class="bg-blue-500 text-white px-4 py-2 rounded ml-2"
                                    onclick="showUserDetails({{ $user->Id_user }})">Détail
                            </button>
                            @if($user->active)
                                <button class="bg-red-500 text-white px-4 py-2 rounded"
                                        onclick="deactivateUser({{ $user->Id_user }})">Suspendre
                                </button>
                            @else
                                <button class="bg-green-500 text-white px-4 py-2 rounded"
                                        onclick="activateUser({{ $user->Id_user }})">Activer
                                </button>
                            @endif
                        </td>
                    </tr>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                ...
                <form id="userDetailsForm">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="active" id="detail-active"
                                class="mt-1 p-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    ...
                    <div class="mb-4">
                        <label for="detail-nb-groovies" class="block text-sm font-medium text-gray-700">Nb
                            Groovies</label>
                        <input type="text" id="detail-nb-groovies"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="detail-level"
                               class="mt-1 p-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="firstname" id="detail-firstname"
                               class="mt-1 p-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>
                    <div class="mb-4">
                        <label for="detail-city" class="block text-sm font-medium text-gray-700">Ville</label>
                        <input type="text" name="city" id="detail-city"
                               class="mt-1 p-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>
