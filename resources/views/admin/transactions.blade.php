                    ...
                    @foreach($groovers as $groover)
                        <div class="swiper-slide">
                            <div class="relative max-w-xs border border-solid border-gray-200 rounded-2xl p-4 transition-all duration-500 card">
                                ...
                                <p class="text-sm font-normal text-gray-500 transition-all duration-500 leading-5 mb-4">
                                    Nombre de groovies : {{ $groover->nb_groovies }}</p>
                                <p class="text-sm font-normal text-gray-500 transition-all duration-500 leading-5 mb-4">
                                    Niveau : {{ $groover->level }}</p>
                                <a href="javascript:;"
                                   class="group flex items-center gap-2 text-sm font-semibold text-indigo-600 transition-all duration-500">Détail
                                    <svg class="transition-all duration-500 group-hover:translate-x-1" width="18"
                                         height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2.25 9L14.25 9M10.5 13.5L14.4697 9.53033C14.7197 9.28033 14.8447 9.15533 14.8447 9C14.8447 8.84467 14.7197 8.71967 14.4697 8.46967L10.5 4.5"
