...
//ADMIN
Route::get('/admin/connexion', [AdminController::class, 'showLoginForm'])->name('admin.login')->middleware(RedirectIfAdmin::class);
Route::post('/admin/connexion', [AdminController::class, 'login']);
Route::get('/admin/dashboard', [AdminController::class, 'index'])->name('admin.dashboard')->middleware(RedirectIfNotAdmin::class);
